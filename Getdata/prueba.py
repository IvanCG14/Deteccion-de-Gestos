...
with mp_hands.Hands(
    ...
    while webcam.isOpened():
        ...
        handNumber = 0
        hand_landmarks_list = [] # Cambiado el nombre para evitar confusión con el landmark de un solo dedo.
        isCounting = False
        count = 0

        # Si se detecta al menos una mano, se ejecuta
        if results.multi_hand_landmarks:
            isCounting = True

            # Lógica para la elección del CPU y actualización del marcador
            ...
            # Dibujo de los esqueletos de las manos y numeración de landmarks
            for hand in results.multi_hand_landmarks:
                ...
                hand_landmarks = [] # Lista temporal para los landmarks de la mano actual
                ...
                for id, landmark in enumerate(hand.landmark):
                    ...
                    # Añadir la numeración del landmark (id) al lado de cada punto
                    cv2.putText(image, str(id), (xPos + 5, yPos + 5),
